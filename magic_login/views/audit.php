        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tw-flex tw-items-start tw-justify-between tw-gap-4 tw-mb-5">
                    ...
                    <a class="btn btn-default" href="<?php echo admin_url('magic_login'); ?>"><i class="fa-solid fa-arrow-left tw-mr-1"></i> Login Links</a>
                </div>
                    ...
                    <div class="panel-body">
                        <div class="tw-flex tw-flex-wrap tw-items-center tw-justify-between tw-gap-3 tw-mb-4">
                            ...
                            <div class="tw-flex tw-flex-wrap tw-items-center tw-gap-2">
                                <select id="magic-login-audit-event" name="event" class="form-control" style="width:180px;">
                                    ...
                                    <option value="otp_delivery_failed">OTP delivery failed</option>
                                </select>
                                <input type="date" id="magic-login-audit-from" name="date_from" class="form-control" aria-label="From date">
                                <input type="date" id="magic-login-audit-to" name="date_to" class="form-control" aria-label="To date">
                            </div>
                        </div>
                        <div class="panel-table-full">
                            <?php render_datatable([
                                'Time', 'Event', 'Contact', 'Token', 'IP address', 'Details',
