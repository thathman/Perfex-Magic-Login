...
<div class="airix-auth-page airix-auth-page--whatsapp airix-auth-page--verify">
    ...
    <section class="airix-auth-form" aria-labelledby="whatsapp-verify-heading"><div class="airix-auth-form__inner">
        ...
        <?= form_open(site_url('magic_login/whatsapp/verify'), ['class' => 'login-form airix-login-form airix-whatsapp-form']); ?>
        ...
        <?= form_close(); ?>
        <div class="airix-auth-methods"><a class="airix-auth-back" href="<?= site_url('magic_login/whatsapp'); ?>"><i class="fa-solid fa-rotate-left" aria-hidden="true"></i> Request another code</a><a class="airix-auth-secondary" href="<?= site_url('authentication/login'); ?>">Use another method</a></div>
    </div></section>
</div>
